...
class CatalogService1ApplicationTests {
	...
	static void dynamicProperties(DynamicPropertyRegistry registry) {
		registry.add("spring.security.oauth2.resourceserver.jwt.issuer-uri",
				() -> keycloakContainer.getAuthServerUrl() + "realms/PolarBookshop-1");
	}

	@BeforeAll
	static void generateAccessTokens() {
		WebClient webClient = WebClient.builder() //A WebClient used to call Keycloak
				.baseUrl(keycloakContainer.getAuthServerUrl() + "realms/PolarBookshop-1/protocol/openid-connect/token")
	...
	void whenPostRequestUnauthenticatedThen401() {
		var expectedBook = Book.of("1231231231", "Title", "Author", new BigDecimal("9.90"), "Polarsophia");
