...
import com.polarbookshop.catalog.config.DataConfig;
...
public class BookRepositoryJdbcTests {
    ...
    @Test
    void findAllBooks() {
        var book1 = Book.of("1234561235", "Title", "Author", new BigDecimal("12.90"),"vasireddy");
        var book2 = Book.of("1234561236", "Another Title", "Author", new BigDecimal("12.90"),"vasireddy");
    ...
    void findBookByIsbnWhenExisting() {
        ...
        var book = Book.of(bookIsbn, "Title", "Author", new BigDecimal("12.90"),"vasireddy");
    ...
    void existsByIsbnWhenExisting() {
        ...
        var bookToCreate = Book.of(bookIsbn, "Title", "Author", new BigDecimal("12.90"),"vasireddy");
    ...
    void whenCreateBookNotAuthenticatedThenNoAuditMetadata() {
        var bookToCreate = Book.of("1232343456", "Title", "Author", new BigDecimal("12.90"), "Polarsophia");
    ...
    void whenCreateBookAuthenticatedThenAuditMetadata() {
        var bookToCreate = Book.of("1232343457", "Title", "Author", new BigDecimal("12.90"), "Polarsophia");
        var createdBook = bookRepository.save(bookToCreate);
